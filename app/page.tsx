          ...
          <>
            ...
            <details className="mt-4 border border-border rounded-lg overflow-hidden">
              ...
              <div className="p-3 space-y-4">
                ...
                <div>
                  <label className="block text-xs text-text-dim mb-1">
                    Custom Test Prompts <span className="text-text-dim">(JSON array, optional)</span>
                  </label>
                  <textarea
        ...
        <section className="mb-6">
          ...
          {results.map((batch, i) => (
            <div key={i} className="mb-6">
              ...
              <p className="text-text-dim text-sm mb-2">{batch.skill.description}</p>
